...
var mail_handler = ((ToSend,ToSendName) => {
  ...
  auth: {
    ...
    let mailOptions = {
        ...
        html: `<p>Thankyou <b>${ToSendName}</b>!<p>You have been registered for MANTHAN.</p><p>Here's what you'll need to know before the test :</p><br><p>1) The test will include aptitude and coding questions.</p><p>2) You will be given 60 minutes to solve the test. Try to solve as many problems as you can.</p><p>3) The complete audition process would be fair and transparent. </p><br><p>ALL THE BEST ! </p><p>See you on 13 September 18.</p><br><p>Regards,</p><p>Manan - A Techno Surge</p>` // html body
    };
